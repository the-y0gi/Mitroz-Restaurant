...
const MENU_ITEMS = [
  {
    ...
    tag: "Bestseller",
    description:
      "Soft cottage cheese dumplings soaked in chilled saffron-flavored sweet milk.",
    price: "149",
    image:
      "https://media.istockphoto.com/id/2229698116/photo/delicious-rasmalai-served-in-a-bowl-placed-beside-a-decorative-rakhi-and-a-traditional-roli.jpg?s=2048x2048&w=is&k=20&c=UDo5eQQgGZfylDaCO64eMODJJEwWQZ3ciIaaVQ44SWM=",
    type: "veg",
    spiceLevel: 4,
  },
  {
    ...
    description:
      "Chilled guava juice infused with secret Indian spices and a hint of lemon zest.",
    price: "249",
    image:
      "https://plus.unsplash.com/premium_photo-1692810407604-8e58c63563d5?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    type: "veg",
  ...
  },
  {
    ...
    description:
      "Refreshing blue curacao syrup mixed with sparkling soda and fresh mint leaves.",
    price: "219",
    image:
  ...
  },
  {
    ...
    description:
      "Cottage cheese marinated in rich cream and aromatic spices, char-grilled to perfection.",
    price: "399",
    image:
  ...
  },
  {
    ...
    description:
      "Deep fried American corn tossed with peppers, onions and Chinese herbs.",
    price: "299",
    image:
  ...
  },
  {
    ...
    description:
      "Black lentils simmered overnight on slow coal fire with butter and cream.",
    price: "449",
    image:
  ...
  },
  {
    ...
    description:
      "Tandoori chicken cooked in rich tomato gravy with butter and fenugreek.",
    price: "549",
    image:
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
          {filteredItems.length > 0 ? (
            filteredItems.map((item) => (
              <div
                key={item.id}
                className="group relative bg-white rounded-3xl p-4 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 border border-gray-100/50"
              >
                {/* Image Section */}
                <div className="relative h-64 rounded-2xl overflow-hidden mb-5">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 p-1.5 rounded-lg shadow-sm backdrop-blur-md">
                    <div
                      className={`border ${item.type === "veg" ? "border-green-600" : "border-red-600"} p-[2px]`}
                    >
                      <div
                        className={`w-2 h-2 ${item.type === "veg" ? "bg-green-600" : "bg-red-600"} rounded-full`}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="px-2">
                  ...
                  {item.spiceLevel && (
                    <div
                      className="flex gap-0.5 mb-3 opacity-60"
                      title="Spice Level"
                    >
                      {[...Array(3)].map((_, i) => (
                        <Flame
